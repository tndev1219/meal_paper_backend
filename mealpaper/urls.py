...
from apps.property.views import AgencyViewSet, SalutariumViewSet, PaperViewSet, DeviceTokenViewSet
...
router.register(r'agency', AgencyViewSet, base_name='agency')
